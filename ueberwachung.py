...
<img src="stream.mjpg" width="853" height="480" />
</body>
</html>
"""
...
tuning = Picamera2.load_tuning_file("imx708.json", dir='.')
picam2 = Picamera2(tuning=tuning)
#picam2 = Picamera2()
picam2.configure(picam2.create_video_configuration(main={"size": (853, 480)}))
output = StreamingOutput()
#picam2.set_controls({"AfMode": 2, "AfTrigger": 0})
scm = picam2.camera_properties['ScalerCropMaximum']
h = scm[3]-scm[1]
w = scm[2]-scm[0]
rect = (scm[0]+5*w//11, scm[1]+5*h//11, w//11, h//11)
